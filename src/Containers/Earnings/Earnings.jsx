...
const Earnings = () =>{
    const [earning_data,set_earning_data] = new useState([
        {title:'STAKE BND',headingp1:'Earn M̷̷ARS by staking your BNB',headingp2:'Minimum bnb stake is 0.047 BNB',headingp3:'You cannot unstake your BNB',apr:'73000%',my_stake:'0.0000 BNB',total_staked:'0.3634 BNB',mars_earned:'0.0000',stack:'false',unstake:'false',enable:'true',walletBallance:'0.0000 BNB'},
        {title:'STAKE M̷̷ARS',headingp1:'Stake M̷̷ARS to earn more M̷̷ARS',headingp2:'You can stake as many times as you want',headingp3:'You can unstake your M̷̷ARS after 7 days',apr:'2190%',my_stake:'0.0000 M̷̷ARS',total_staked:'0.2200 M̷̷ARS',mars_earned:'0.0000',stack:'false',unstake:'true',enable:'true',walletBallance:'0.0000 M̷̷ARS'}
    ])
    return(
        <div className="justify-content-center row my-5"> 
            <div className="Earnings row col-xxl-8 col-10 justify-content-around gy-4">
                <Earning data={earning_data[0]}></Earning>
                <Earning data={earning_data[1]}></Earning>
                <div className="Earning col-lg-3 col-md-5 p-0">
                    <div className="p-3">
